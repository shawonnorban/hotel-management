...
//Get Update file
define('MIN_VERSION', @file_get_contents('http://update.bdtask.com/xainhotel/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', @file_get_contents('http://update.bdtask.com/xainhotel/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','http://update.bdtask.com/xainhotel/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','http://update.bdtask.com/xainhotel/autoupdate/update_info');
// CRM temporary path
...
class Autoupdate extends MX_Controller {
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->session->set_flashdata('exception', 'Purchase key is required');            
        }
