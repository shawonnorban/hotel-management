      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          <label for="date" class="col-sm-3 col-form-label"><?php echo display('date') ?> <span
              class="text-danger">*</span></label>
          <div class="col-sm-9">
            <input name="date" class="form-control datepickers" type="text"
              value="<?php echo html_escape($data->date) ?>">
          </div>
        </div>
        <div class="form-group row">
          <label for="sign_in" class="col-sm-3 col-form-label"><?php echo display('sign_in') ?> </label>
          <div class="col-sm-9">
            <input name="sign_in" class=" form-control atttimepicker" type="text"
              value="<?php echo html_escape($sign_in = $data->sign_in) ?>" id="sign_in">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" name="sign_out" class="form-control atttimepicker" id=""
              value="<?php echo html_escape($sign_out = $data->sign_out); ?>">
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            if (!empty($sign_in) && !empty($sign_out)) {
              ...
              echo 'N/A'; // Display N/A if either $sign_in or $sign_out is empty
            }
            ?>">
          </div>
