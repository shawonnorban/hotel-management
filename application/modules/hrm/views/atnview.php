            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <?php echo form_open('hrm/Home/create_atten', ['id' => 'attendanceForm']); ?>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <button type="button" class="btn btn-danger w-md m-b-5" id="cancelBtn">&times; <?php echo display('cancel') ?></button>
                                        <button type="button" class="btn btn-success w-md m-b-5" id="sign_in"><?php echo display('sign_in') ?></button>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
...
<input type="hidden" id="timezone" value="<?php echo isset($timezone) ? html_escape($timezone->timezone) : ''; ?>">
<!-- Start Modal -->
<script src="<?php echo MOD_URL . $module; ?>/assets/js/atnview.js?v=<?php echo date('d');?>"></script>