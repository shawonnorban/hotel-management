            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 themeupload">
                        <div class="pull-left overwrite">
                            <button type="submit"
                                class="btn btn-success ml-2"><?php echo display('add_module') ?></button>
                        </div>
                    </div>
                </div>
                <?php echo form_close() ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 addonsbox">
                        <div class="thumbnail">
                            <div class="addon_img">
                                <img src="<?php echo (!empty($livemod->thumb)?$livemod->thumb:NO_IMAGE) ?>" alt=""
                                    class="mod_thumb_img">
                            </div>
                            <div class="caption">
                                <h3><span class="addon_title"> <?php echo html_escape($livemod->module_name); ?></span>
                                    ...
                                    <span
                                        class="price addon_price">$<?php echo number_format($livemod->price,2); ?></span>

                                </h3>
                                <p class="caption_desc"><?php echo $livemod->short_description; ?></p>
                                <p>
                                    <a href="<?php echo $livemod->payment_url; ?>" target="_blank" role="button"
                            ...
                            <div class="caption">
                                ...
                                <p>
                                    ...
                                    <a onclick="return confirm('<?php echo display('are_you_sure') ?>')"
                                        ...
                                        href="<?php echo base_url($mod.'/hrmscheduler/zip_download?module='.$mod.'&is_download=yes&downloadas=zip&downloadid='.md5('BDT'.$mod)) ?>">
                                        <?php echo display("download") ?></a>
                                    <?php } }
                                        // desktop
                                                    $rows = null;
