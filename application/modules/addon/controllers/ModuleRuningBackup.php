...
class Module extends MX_Controller
{
    ...
    //         $this->session->set_flashdata('exception', display('required_files_missing'));
    //         redirect("addon/module");
    //     }
    
    //     // Include config file and verify HmvcConfig
    //     @include($configPath);
    //     if (!isset($HmvcConfig[$directory])) {
    //         $this->session->set_flashdata('exception', display('invalid_config'));
    //         redirect("addon/module");
    //     }
    ...
    //         $tables = $HmvcConfig[$directory]["_tables"];
    ...
    //             } else {
    //                 $this->session->set_flashdata('exception', "`$table` " . display('table_not_found_in_sql'));
    //                 redirect("addon/module");
    //             }
    //         }
    ...
    //         }
    //     } else {
    //         $this->session->set_flashdata('exception', display('no_tables_registered'));
    //     }
