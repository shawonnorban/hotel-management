...
function cancelreservation(id) {
  ...
  var myurl =
    baseurl + "room_reservation/room_reservation/cancelreservation" + "/" + id;
  var dataString = "id=" + id;
  $.ajax({
    type: "GET",
    url: myurl,
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if ($("#checkin_list").length) {
        $("#view_checin").text("");
        $("#view_checin").append(
          "<i class='ti-plus' aria-hidden='true'></i> Check In List"
        );
      }
...
function checkinresrvation(id) {
  ...
  var csrf = $("#csrf_token").val();
  var myurl =
    baseurl + "room_reservation/room_reservation/bookingcheckin/" + id;
  $.ajax({
    url: myurl,
    type: "POST",
    data: {
...
function checkoutresrvation(id) {
  ...
  var csrf = $("#csrf_token").val();
  var myurl =
    baseurl + "room_reservation/room_reservation/bookingcheckout/" + id;
  $.ajax({
    url: myurl,
    type: "POST",
    data: {
...
function printresrvation(id) {
  ...
  var csrf = $("#csrf_token").val();
  var myurl =
    baseurl + "room_reservation/room_reservation/viewdetailsprint/" + id;
  $.ajax({
    url: myurl,
    type: "POST",
    data: {
